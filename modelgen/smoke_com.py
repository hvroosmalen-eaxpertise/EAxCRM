"""Minimal EA COM smoke script — opens the live .qea and lists top-level
packages. Wrapped in main() behind a __main__ guard so importing this module
does not spawn an EA process.
"""
import sys, os
