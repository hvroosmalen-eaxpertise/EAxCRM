"""Manual ArchiMate3 element-creation smoke script — DESTRUCTIVE against the
live .qea (adds a 'Test Business Actor' element + tagged value + diagram).
Wrapped in main() behind a __main__ guard so `import smoke_archimate` is safe.
Real automated coverage lives in test_generators_regression.py against a
sandboxed .qea copy.
"""
import sys, os
