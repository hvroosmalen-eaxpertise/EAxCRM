"""EA COM API Element-property discovery smoke script — opens the live .qea
and dumps every accessible attribute of the first EAxCRM element. Wrapped in
main() behind a __main__ guard so importing this module does not spawn an EA
process.
"""
