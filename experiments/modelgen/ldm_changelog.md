...
| eid | Name | Type | GUID |
|-----|------|------|------|
| r-contact-contactrole | Contact -> ContactRole | Association | {3DBF8255-F31C-4bd9-B605-506AECF82439} |

### Updated
| eid | Name | Type | GUID | Changes |
|-----|------|------|------|---------|
| contactrole | ContactRole | Enumeration | {8D17DAE4-DC3B-40a8-B840-078D9B54DA28} |  |
...
| r-communication-contact | Communication -> Contact | Association | {38417872-F993-4329-84B6-B967B753068C} |  |
| r-communication-customer | Communication -> Customer | Association | {E94DA153-89B2-4897-B260-28141E5A22C2} |  |
...
| eid | Name | Type | GUID |
|-----|------|------|------|
| linked_to_contact | linked_to_contact | Attribute |  |

## 2026-07-08 16:31:01 — Audit
...
## 2026-07-08 16:28:58 — Audit

### Checkpoints
- Sync from EA

## 2026-07-08 16:28:42 — Audit
...
## 2026-07-08 16:25:03 — Audit

### Checkpoints
- Sync from EA

## 2026-07-08 16:23:45 — Audit

### Checkpoints
- Sync from EA

## 2026-07-08 16:23:30 — Audit
...
| attachment | Attachment | Class | {7166AEE8-CF2D-4372-BC23-068A510B0124} |  |
| communication | Communication | Class | {94C6CD4B-43EF-4e8d-A190-EC98D38FF05B} |  |
| contact | Contact | Class | {DEF8F388-8B44-4425-9F79-7FE63A4C6A0E} | Notes: A person associated with a customer, with a specific role. Role is one of Primary, Purchase, Sales, License Holder, or Secondary (CRM-1, CRM-10) — not yet enforced as a formal enum in the schema (plain string(20)). Business rules constrain assignment: exactly one Contact per Customer must be Primary (CRM-8), and role becomes mandatory on every row once a second Contact exists (CRM-9). -> A person associated with a customer, with a specific role. Exactly one Contact per Customer must be Primary (CRM-8), and role becomes mandatory on every row once a second Contact exists (CRM-9). |
| customer | Customer | Class | {700996C9-A075-4773-9696-9C9C89125192} | Notes: An organization that uses Sparx EA and receives services from EAxpertise. address is currently a single unstructured string; CRM-7 requires it be decomposed into a structured street address (street_name, house_number, postal_code, city, country) or an unstructured PO Box string, selected via a mode toggle — not yet reflected in this schema. -> An organization that uses Sparx EA and receives services from EAxpertise. Address is either a structured street address or a PO Box, selected via address_mode (CRM-7). |
| delivery | Delivery | Class | {0CB6B189-C3BB-4eb4-9E09-DC17356387D7} |  |
| imapaccount | ImapAccount | Class | {3BD8E116-FF59-4ce7-B1DA-F3B3D854FD53} |  |
| license | License | Class | {B9E262AA-8193-4c39-B5B8-38AF63395457} |  |
| licenselineitem | LicenseLineItem | Class | {1C8F5735-6BF1-4461-819D-2B729F60AD46} |  |
...
## 2026-07-08 15:41:16 — Audit

### Checkpoints
- Sync from EA

## 2026-07-08 15:40:43 — Audit
...
| article | Article | Class | {A8A1C7F5-AB9E-477d-82C1-96C80B5C9F42} |  |
| attachment | Attachment | Class | {7166AEE8-CF2D-4372-BC23-068A510B0124} |  |
| communication | Communication | Class | {94C6CD4B-43EF-4e8d-A190-EC98D38FF05B} | Notes: Email message retrieved from an IMAP account. -> Email message retrieved from an IMAP account. linked_to_contact is currently a boolean flag only — CRM-2 requires each Communication to be associated with the matching Customer, with unmatched emails flagged for manual linking rather than silently dropped, which needs an actual FK (to Contact and/or Customer) not yet present in this schema. |
| contact | Contact | Class | {DEF8F388-8B44-4425-9F79-7FE63A4C6A0E} | Notes: A person associated with a customer, with a specific role. -> A person associated with a customer, with a specific role. Role is one of Primary, Purchase, Sales, License Holder, or Secondary (CRM-1, CRM-10) — not yet enforced as a formal enum in the schema (plain string(20)). Business rules constrain assignment: exactly one Contact per Customer must be Primary (CRM-8), and role becomes mandatory on every row once a second Contact exists (CRM-9). |
| customer | Customer | Class | {700996C9-A075-4773-9696-9C9C89125192} | Notes: An organization that uses Sparx EA and receives services from EAxpertise. -> An organization that uses Sparx EA and receives services from EAxpertise. address is currently a single unstructured string; CRM-7 requires it be decomposed into a structured street address (street_name, house_number, postal_code, city, country) or an unstructured PO Box string, selected via a mode toggle — not yet reflected in this schema. |
| delivery | Delivery | Class | {0CB6B189-C3BB-4eb4-9E09-DC17356387D7} |  |
| imapaccount | ImapAccount | Class | {3BD8E116-FF59-4ce7-B1DA-F3B3D854FD53} |  |
| license | License | Class | {B9E262AA-8193-4c39-B5B8-38AF63395457} |  |
| licenselineitem | LicenseLineItem | Class | {1C8F5735-6BF1-4461-819D-2B729F60AD46} |  |
